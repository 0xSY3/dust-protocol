...
///         Public signals format: [root, nullifierHash, recipient, relayer, fee, swapAmountOut]
///
...
contract DustSwapVerifier is IDustSwapVerifier {
    ...
    // IC points (placeholder — 7 points for 6 public signals)
    // IC[0] is the base, IC[1..6] correspond to public signals
    ...
    /// @param _pubSignals Public signals [6 uint256]:
