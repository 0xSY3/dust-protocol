...
export const RailgunProxyContract: Record<NetworkName, string> = {
  ...
  [NetworkName.ThanosSepolia]: '0x2100199A72f628eac3E73022a59e8CFDFd5EeAF0',
...
export const RelayAdaptContract: Record<NetworkName, string> = {
  ...
  [NetworkName.ThanosSepolia]: '0xD7Ec2400B53c0E51EBd72a962aeF15f6e22B3b89',
...
export const RailgunProxyDeploymentBlock: Record<NetworkName, number> = {
  ...
  [NetworkName.ThanosSepolia]: 6298958,
...
export const BaseTokenWrappedAddress: Record<NetworkName, string> = {
  ...
  [NetworkName.ThanosSepolia]: '0xd3Edf982443995e85743b19f5300EfF700c1c725', // (Thanos) WTON
...
export const NETWORK_CONFIG: Record<NetworkName, Network> = {
  ...
  [NetworkName.ThanosSepolia]: {
    ...
    name: NetworkName.ThanosSepolia,
    publicName: 'Thanos Sepolia Testnet',
    shortPublicName: 'Thanos',
    coingeckoId: '',
    baseToken: {
      symbol: 'TON',
      wrappedSymbol: 'WTON',
      wrappedAddress: BaseTokenWrappedAddress[NetworkName.ThanosSepolia],
      decimals: 18,
    },
    proxyContract: RailgunProxyContract[NetworkName.ThanosSepolia],
    relayAdaptContract: RelayAdaptContract[NetworkName.ThanosSepolia],
    relayAdaptHistory: [
      '0xD7Ec2400B53c0E51EBd72a962aeF15f6e22B3b89',
    ],
    supports7702: false,
    relayAdapt7702Contract: RelayAdapt7702Contract[NetworkName.ThanosSepolia],
    relayAdapt7702History: [],
    railgunRegistryContract:
      RailgunRegistryContract[NetworkName.ThanosSepolia],
    deploymentBlock: RailgunProxyDeploymentBlock[NetworkName.ThanosSepolia],
    isDevOnlyNetwork: true,
    isTestnet: true,
    defaultEVMGasType: EVMGasType.Type2,
    poseidonMerkleAccumulatorV3Contract:
      RailgunPoseidonMerkleAccumulatorV3Contract[NetworkName.ThanosSepolia],
    poseidonMerkleVerifierV3Contract:
      RailgunPoseidonMerkleVerifierV3Contract[NetworkName.ThanosSepolia],
    tokenVaultV3Contract: RailgunTokenVaultV3Contract[NetworkName.ThanosSepolia],
    deploymentBlockPoseidonMerkleAccumulatorV3:
      RailgunPoseidonMerkleAccumulatorV3DeploymentBlock[
        NetworkName.ThanosSepolia
      ],
