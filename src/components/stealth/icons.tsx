...
export const USDCIcon = ({ size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
    ...
    <path d="M21.28 17.52c0-2.48-1.56-3.8-4.84-4.2l-2.04-.24c-1.32-.16-1.84-.52-1.84-1.28 0-.84.72-1.36 1.84-1.36 1.16 0 1.8.44 1.88 1.28h2.64c-.16-1.8-1.48-3.08-3.48-3.48V6.16h-2.12v2.04c-1.92.32-3.4 1.56-3.4 3.48 0 2.48 1.52 3.76 4.72 4.16l2.16.28c1.4.16 1.96.6 1.96 1.36 0 1-.84 1.48-2.04 1.48-1.32 0-2.16-.6-2.28-1.64h-2.68c.24 2.12 1.68 3.52 3.92 3.88v2.04h2.12v-2.04c2.08-.32 3.48-1.68 3.48-3.64" fill="white" />
  </svg>
);
