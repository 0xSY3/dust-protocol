...
export const ArbitrumIcon = ({ size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 40 40" fill="none">
    <rect width="40" height="40" rx="20" fill="#2D374B" />
    <path d="M22.12 14.06l-1.97 3.2 5.87 9.53 2.42-1.4-6.32-11.33z" fill="#28A0F0" />
    <path d="M27.16 26.12l1.42-.82-5.06-9.08-1.4 2.28 5.04 7.62z" fill="#28A0F0" />
    <path d="M20.15 17.26l-5.87 9.53 2.42 1.4 5.43-8.66-1.98-2.27z" fill="white" />
    <path d="M14.28 25.3l-1.42-.82 5.32-8.64 1.97 2.27-5.87 7.19z" fill="white" />
    <path d="M20 10.5l-7.58 4.38a1.5 1.5 0 0 0-.75 1.3v8.75l1.9 1.1V15.87a.5.5 0 0 1 .25-.43L20 12.07a.5.5 0 0 1 .5 0l6.18 3.57a.5.5 0 0 1 .25.43v10.16l1.9-1.1v-8.95a1.5 1.5 0 0 0-.75-1.3L20.5 10.5a.99.99 0 0 0-.5 0z" fill="#28A0F0" />
    <path d="M20 29.5l7.08-4.09-1.9-1.1L20 27.44l-5.18-3.13-1.9 1.1L20 29.5z" fill="#96BEDC" />
  </svg>
);
